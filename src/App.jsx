    ...
    <div>
      ...
      <header class="container">
        <div class="content">
          ...
          <H1>
            {" "}
            <span> Rajabova shahzoda</span> Web Developer
          </H1>
          <p>
      ...
      <section class="container">
        ...
        <div class="features">
          <div class="card">
            ...
            <p>
              My tutorials in my channel "AsmrProg" are free and you don't need
              to pay anything.
            </p>
            <a href="#">
          ...
          <div class="card">
            ...
            <h4>Fix Your Bugs</h4>
            <p>
              You have any problem in your codes? Tell me, i will help you fix
              it.
            </p>
            <a href="#">
              Join Now <i class="ri-arrow-right-line"></i>
          ...
          <div class="card">
            ...
            <p>
              We have video each 4 days, So check channel every 4 days to watch
              it!
            </p>
            <a href="#">
              Join Now <i class="ri-arrow-right-line"></i>
